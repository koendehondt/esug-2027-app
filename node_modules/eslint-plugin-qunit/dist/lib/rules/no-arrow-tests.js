    ...
    create: function (context) {
        ...
        function fixArrowFunction(fixer, fn) {
            ...
            if (fn.body.type === "BlockStatement") {
                ...
                return fixer.replaceTextRange([fn.range[0], fn.body.range[0]], formatFunctionHead(fn));
            }
            const bodyText = sourceCode.text.slice(fn.body.range[0], fn.body.range[1]);
            return fixer.replaceTextRange([fn.range[0], fn.range[1]], `${formatFunctionHead(fn)}{ return ${bodyText}; }`);
        }
        /**
         * @param {import('estree').Node} fn
         */
        ...
        function isModuleProperty(propertyNode) {
            return (propertyNode.type === "Property" &&

...
module.exports = {
    ...
    create: function (context) {
        ...
        function getCallbackArg(args) {
            ...
            return args
                .slice(1, 3)
                .find((arg) => ["FunctionExpression", "ArrowFunctionExpression"].includes(arg.type));
        }
        /**
        ...
        return {
            ...
            CallExpression: function (node) {
                if (utils.isModule(node.callee)) {
                    ...
                    const description = arg.type === "Literal" && typeof arg.value === "string"
                        ? arg.value
                    ...
                    const hooksParam = getHooksIdentifierFromParams(callback.params);

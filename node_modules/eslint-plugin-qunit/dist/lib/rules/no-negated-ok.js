 ...
 */
"use strict";
const assert = require("node:assert"), utils = require("../utils");
...
module.exports = {
    ...
    create: function (context) {
        ...
        const asyncStateStack = [], ASSERTIONS_TO_CHECK = new Set([
            ...POSITIVE_ASSERTIONS,
            ...NEGATIVE_ASSERTIONS,
        ]), 
        ...
        function getNegationDepth(argNode) {
            let negationDepth = 0, node = argNode;
            while (node &&
        ...
        function checkForNegation(callExprNode) {
            if (callExprNode.type === "CallExpression" &&
                ...
                const firstArgNode = callExprNode.arguments[0], negationDepth = getNegationDepth(firstArgNode);
                if (negationDepth % 2 === 1) {
                    context.report({
                        ...
                        fix(fixer) {
                            ...
                            const propertyName = callExprNode.callee.property.name;
                            ...
                            const oppositeAssertionFunctionName = ASSERTION_OPPOSITES[propertyName];
        ...
        return {
            CallExpression: function (node) {
                ...
                else if (isAssertion(node.callee) &&

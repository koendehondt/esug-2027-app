...
module.exports = {
    ...
    create: function (context) {
        ...
        const testStack = [], RELATIONAL_OPS = new Set([
            "==",
            "!=",
            "===",
            "!==",
        ...
        function checkAndReport(callExprNode, literalNode, binaryExprNode) {
            if (binaryExprNode.type === "BinaryExpression" &&
                ...
                context.report({
                    ...
                    fix(fixer) {
                        ...
                        /* istanbul ignore next */
                        if (callExprNode.callee.property.type !== "Identifier") {
                            return null;
                        }
        ...
        function checkAssertArguments(callExprNode) {
            ...
            if (firstTwoArgsSorted[0].type === "Literal" &&

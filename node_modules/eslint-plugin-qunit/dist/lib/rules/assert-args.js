...
module.exports = {
    ...
    create: function (context) {
        ...
        function checkAssertArity(callExpressionNode) {
            ...
            const allowedArities = utils.getAllowedArities(callExpressionNode.callee, assertContextVar), assertArgs = callExpressionNode.arguments, lastArg = assertArgs[assertArgs.length - 1], mayHaveMessage = lastArg && isPossibleMessage(lastArg);

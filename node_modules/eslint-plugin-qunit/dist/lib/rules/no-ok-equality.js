...
module.exports = {
    ...
    create: function (context) {
        ...
        const asyncStateStack = [], DEFAULT_OPTIONS = {
            allowGlobal: true,
        ...
        function isOk(calleeNode) {
            ...
            const isOk = calleeNode.type === "Identifier" &&
        ...
        function isNotOk(calleeNode) {
            const assertContextVar = getAssertContextVar();
            const isNotOk = calleeNode.type === "Identifier" &&
        ...
        function checkArguments(args, isCalleeNegative, isGlobal, node) {
            ...
            if (args.length > 0) {
                const firstArg = args[0], isArgEqual = isEqual(firstArg), isArgStrictEqual = isStrict(firstArg), isArgNegative = isNegative(firstArg);

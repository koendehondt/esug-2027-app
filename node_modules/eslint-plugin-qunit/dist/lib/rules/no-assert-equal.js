...
// Requirements
//------------------------------------------------------------------------------
const assert = require("node:assert"), utils = require("../utils"), { ReferenceTracker } = require("@eslint-community/eslint-utils");
//------------------------------------------------------------------------------
// Rule Definition
//------------------------------------------------------------------------------
                ...
                suggest: [
                    {
                        ...
                        fix(fixer) {
                            ...
                            return fixer.replaceText(nodeToReplace, "deepEqual");
                        },
                    },
                    {
                        ...
                        fix(fixer) {
                            ...
                            return fixer.replaceText(nodeToReplace, "propEqual");
                        },
                    },
                    {
                        ...
                        fix(fixer) {
                            ...
                            return fixer.replaceText(nodeToReplace, "strictEqual");
                        },
                    },
                ],
            });

...
export declare function auditJS(rawSource: string, filename: string, babelConfig: TransformOptions, frames: CodeFrameStorage): Promise<{
...
//# sourceMappingURL=babel-visitor.d.ts.map
...
function builtInKeywords(emberVersion) {
    ...
    // imports.
    const embroiderTemplateMacroHelpers = {
        macroGetOwnConfig: {},
        macroGetConfig: {},
        macroCondition: {},
...
class TemplateResolver {
    constructor(env, config, builtInsForEmberVersion, supportsThisFallback, externalNameHint, externalResolve) {
        this.env = env;
        this.config = config;
...
function makeResolverTransform({ appRoot, emberVersion, externalNameHint, externalResolve }) {
    ...
    const resolverTransform = env => {
        ...
        return new TemplateResolver(env, config, builtInKeywords(emberVersion), supportsThisFallback(emberVersion), externalNameHint, externalResolve);
    };

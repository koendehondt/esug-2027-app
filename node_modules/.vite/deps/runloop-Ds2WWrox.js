...
import { at as flushAsyncObservers } from "./set_properties-BghuuGJx-CRFenNvF.js";
import { y as assert } from "./debug-BQ1Lq6xe.js";
//#region node_modules/ember-source/dist/dev/packages/@ember/-internals/error-handling/index.js
var onerror;
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/backburner.js/index.js
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/runloop/index.js
...
function bind(...curried) {
	!function(methodOrTarget, methodOrArg) {
		...
		else if (length === 1) return typeof methodOrTarget === "function";
		else return typeof methodOrArg === "function" || methodOrTarget !== null && typeof methodOrArg === "string" && methodOrArg in methodOrTarget || typeof methodOrTarget === "function";
...
//#endregion
export { bind as a, once as c, schedule as d, scheduleOnce as f, setOnerror as g, setDispatchOverride as h, _rsvpErrorQueue as i, run as l, getOnerror as m, _cancelTimers as n, cancel as o, getDispatchOverride as p, _getCurrentRunLoop as r, join as s, _backburner as t, runloop_exports as u };

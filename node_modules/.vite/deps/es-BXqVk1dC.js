//#region node_modules/dom-element-descriptors/dist/es/index.js
var IS_DESCRIPTOR = "__dom_element_descriptor_is_descriptor__";
/**
...
function registerDescriptorData(descriptor, data) {
	if (data) getRegistry().set(descriptor, data);
	else getRegistry().delete(descriptor);
}
/**
...
function resolveDescription(target) {
	return (isDescriptor(target) ? lookupDescriptorData(target) : target)?.description;
}
/**
...
//#endregion
export { resolveDOMElements as a, resolveDOMElement as i, isDescriptor as n, resolveDescription as o, lookupDescriptorData as r, createDescriptor as t };

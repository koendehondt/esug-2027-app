...
import { C as isObject, M as meta, N as peekMeta, a as isClassicDecorator, c as nativeDescDecorator, i as descriptorForProperty, l as setClassicDecorator, o as isElementDescriptor, r as descriptorForDecorator, s as makeComputedDecorator } from "./decorator-B5Uh5NFI-CxIWwiV3.js";
import { b as ENV, y as assert } from "./debug-CzKtnQbf.js";
import { ct as registerDestructor, ot as isDestroyed, rt as destroy, st as isDestroying } from "./args-proxy-BNLuRFlO-EccNNvt4.js";
import { t as OWNER } from "./owner-P0meAleB.js";
import { A as defineProperty, B as hasUnknownProperty, C as ComputedProperty, E as beginPropertyChanges, F as notifyPropertyChange, I as PROXY_CONTENT, K as activateObserver, M as endPropertyChanges, N as expandProperties, O as computed, Q as hasListeners, S as trySet, X as revalidateObservers, Y as removeObserver, Z as addListener, ct as getOwner, et as removeListener, it as observerListenerMetaFor, j as defineValue, k as defineDecorator, n as getProperties, nt as ROOT, ot as setObservers, p as setUnprocessedMixins, q as addObserver, st as wrap, t as setProperties, tt as sendEvent, ut as setOwner, v as DEBUG_INJECTION_FUNCTIONS, x as set, z as get } from "./set_properties-BghuuGJx-DFBAJlFx.js";
//#region node_modules/ember-source/dist/dev/packages/shared-chunks/dictionary-gc5gpyOG.js
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/shared-chunks/container-BzzHmCNj.js
var leakTracking;
var containers;
try {
	if (typeof gc === "function") leakTracking = (() => {
		...
		return {
			...
			reset() {
				...
				for (let i = 0; i < values.length; i++) containers.delete(values[i]);
			}
		};
	})();
} catch (_e) {}
...
var Container = class {
	...
	constructor(registry, options = {}) {
		...
		if (containers !== void 0) containers.add(this);
	}
	/**
	@private
	@property registry
...
function factoryFor(container, normalizedName, fullName) {
	...
	if (factory && typeof factory._onLookup === "function") factory._onLookup(fullName);
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/shared-chunks/intern-zquhAEIg.js
/**
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/shared-chunks/guid-Cbq2sNV_.js
/**
@module @ember/object
*/
/**
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/object/mixin.js
/**
...
function applyConcatenatedProperties(key, value, values) {
	...
	if (typeof ret === "object" && ret !== null) Object.freeze(ret);
	return ret;
}
function applyMergedProperties(key, value, values) {
	let baseValue = values[key];
	isArray$1(value) && assert(`You passed in \`${JSON.stringify(value)}\` as the value for \`${key}\` but \`${key}\` cannot be an Array`, !isArray$1(value));
...
var Mixin = class Mixin {
	...
	constructor(mixins, properties) {
		...
		if (Mixin._disableDebugSeal !== true) Object.seal(this);
	}
	/**
	@method create
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/-internals/runtime/lib/mixins/action_handler.js
/**
@module ember
*/
/**
	...
	*/
	send(actionName, ...args) {
		...
		if (this.actions && this.actions[actionName]) {
			if (!(this.actions[actionName].apply(this, args) === true)) return;
		}
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/array/lib/make-array.js
var { isArray } = Array;
/**
@module @ember/array
*/
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/object/core.js
...
var initCalled = /* @__PURE__ */ new WeakSet();
...
function initialize(obj, properties) {
	...
	if (properties !== void 0) {
		...
		for (let keyName of keyNames) {
			...
			else defineProperty(obj, keyName, null, value, m);
		}
	}
	initCalled.add(obj);
	obj.init(properties);
...
var CoreObject = class {
	...
	constructor(owner) {
		...
		if (hasUnknownProperty(this)) {
			...
			self = new Proxy(this, { get(target, property, receiver) {
				if (property === PROXY_CONTENT) return target;
				else if (!initCalled.has(receiver) || typeof property === "symbol" || property === "toJSON" || property === "toString" || property === "toStringExtension" || property === "didDefineProperty" || property === "willWatchProperty" || property === "didUnwatchProperty" || property === "didAddListener" || property === "didRemoveListener" || property === "isDescriptor" || property === "_onLookup" || property in target) return Reflect.get(target, property, receiver);
				let value = target.unknownProperty.call(receiver, property);
				if (typeof value !== "function") !(value === void 0 || value === null) && assert(messageFor(receiver, property), value === void 0 || value === null);
			} });
		} else self = this;
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/object/observable.js
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/object/index.js
...
function action(...args) {
	...
	if (!isElementDescriptor(args)) {
		...
		let decorator = function(target, key, _desc, _meta, isClassicDecorator) {
			!isClassicDecorator && assert("The @action decorator may only be passed a method when used in classic classes. You should decorate methods directly in native classes", isClassicDecorator);
...
function observer(...args) {
	...
	!(typeof funcOrDef === "function" || typeof funcOrDef === "object" && funcOrDef !== null) && assert("observer must be provided a function or an observer definition", typeof funcOrDef === "function" || typeof funcOrDef === "object" && funcOrDef !== null);
	let func;
	let dependentKeys;
	let sync;
	...
	!(typeof func === "function") && assert("observer called without a function", typeof func === "function");
	!(Array.isArray(dependentKeys) && dependentKeys.length > 0 && dependentKeys.every((p) => typeof p === "string" && Boolean(p.length))) && assert("observer called without valid path", Array.isArray(dependentKeys) && dependentKeys.length > 0 && dependentKeys.every((p) => typeof p === "string" && Boolean(p.length)));
	!(typeof sync === "boolean") && assert("observer called without sync", typeof sync === "boolean");
	let paths = [];
...
//#endregion
export { Container as _, Observable as a, core_exports as c, Mixin as d, GUID_KEY as f, intern as g, uuid as h, observer as i, makeArray as l, guidFor as m, action as n, observable_exports as o, generateGuid as p, object_exports as r, CoreObject as s, EmberObject as t, ActionHandler as u, getFactoryFor as v, makeDictionary as y };

...
import { S as teardownMandatorySetter, c as nativeDescDecorator, i as descriptorForProperty } from "./decorator-B5Uh5NFI-CxIWwiV3.js";
import { C as hasDOM, m as inspect, y as assert } from "./debug-CzKtnQbf.js";
import { O as DIRTY_TAG, b as isUpdatableRef, x as updateRef, z as createTag } from "./args-proxy-BNLuRFlO-EccNNvt4.js";
import "./capabilities-CZkuOqqC-Bcpl3t5H.js";
import { d as setInternalComponentManager } from "./api-BawZUDYD-Cxxta-tL.js";
import { a as setComponentManager$1, r as componentCapabilities } from "./api-BAmlf_CN-DtAd_Q7k.js";
import { O as computed, ct as getOwner, g as context, w as PROPERTY_DID_CHANGE, y as inject, z as get } from "./set_properties-BghuuGJx-DFBAJlFx.js";
import { d as Mixin, m as guidFor, u as ActionHandler } from "./object-xMsAYsCY.js";
import { s as join } from "./runloop-DUin4ckU.js";
import { c as addChildView, f as getChildViews, i as flaggedInstrument, o as getComponentTemplate, s as setComponentTemplate, v as getViewElement } from "./internal-CAL-jHZt-BX1vvY43.js";
import { c as IS_DISPATCHING_ATTRS, g as EventDispatcher, h as normalizeProperty, i as CURLY_COMPONENT_MANAGER, l as getComponentCapturedArgs, n as Textarea, r as BOUNDS, s as DIRTY_TAG$1, t as Input } from "./textarea-lD4apgrP-C383bER3.js";
...
//#region node_modules/ember-source/dist/dev/packages/@ember/-internals/runtime/lib/mixins/target_action_support.js
/**
@module ember
*/
/**
	...
	triggerAction(opts = {}) {
		...
		if (target && action) {
			...
			if (isSendable(target)) ret = target.send(action, ...context);
				...
				!(typeof target[action] === "function") && assert(`The action '${action}' did not exist on ${target}`, typeof target[action] === "function");
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/-internals/views/lib/views/states.js
	...
	enter(view) {
		view.renderer.register(view);
		{
			...
			Object.defineProperty(view, "elementId", {
				...
				set(value) {
					if (value !== elementId) throw new Error("Changing a view's elementId after creation is not allowed");
				}
			});
		}
	}
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/-internals/views/lib/views/core_view.js
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/-internals/views/lib/mixins/action_support.js
/**
@module ember
*/
/**
...
var ActionSupport = Mixin.create({ send(actionName, ...args) {
	...
	} else !action && assert(`${inspect(this)} had no action handler for: ${actionName}`, action);
} });
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/component/index.js
	...
	init(properties) {
		...
		if (eventDispatcher && this.renderer._isInteractive && this.tagName === "") {
			...
			for (let key in events) {
				...
				if (methodName && typeof this[methodName] === "function") eventNames.push(methodName);
			}
		...
		if (hasDOM) {
			...
			!(() => {
				...
				while (node instanceof Element) {
					if (matches(node, ".ember-view")) return false;
...
//#endregion
export { CoreView as a, ActionSupport as i, component_exports as n, states as o, setComponentManager as r, TargetActionSupport as s, Component as t };

import { R as createCache, W as getValue } from "./args-proxy-BNLuRFlO-EccNNvt4.js";
import { n as tracked } from "./tracked-CKE4wnE6-Ci0Zx02r.js";
//#region node_modules/ember-source/dist/dev/packages/@glimmer/tracking/index.js
/**
* @decorator
*
...
var cached = (...args) => {
	...
	if (target === void 0) throwCachedExtraneousParens();
	if (typeof target !== "object" || typeof key !== "string" || typeof descriptor !== "object" || args.length !== 3) throwCachedInvalidArgsError(args);
	if (!("get" in descriptor) || typeof descriptor.get !== "function") throwCachedGetterOnlyError(key);

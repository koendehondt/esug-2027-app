import { T as tagFor } from "./decorator-B5Uh5NFI-CxIWwiV3.js";
import { f as warn, m as inspect, r as debugFreeze, y as assert } from "./debug-CzKtnQbf.js";
import { L as consumeTag, R as createCache, W as getValue, X as untrack } from "./args-proxy-BNLuRFlO-EccNNvt4.js";
import { n as action } from "./object-xMsAYsCY.js";
import { b as isSimpleClick, i as flaggedInstrument, n as opaquify, t as InternalComponent } from "./internal-CAL-jHZt-BX1vvY43.js";
import { n as getEngineParent } from "./engine-parent-CUOAZ4io.js";
...
import { r as service } from "./service-GO52-9tS.js";
import { c as templateFactory } from "./index-CyZiGiEI-Cq3SnK-P.js";
import { t as on } from "./on-D0ijXIw3.js";
//#region node_modules/ember-source/dist/dev/packages/@ember/routing/index.js
...
var _LinkTo = class extends InternalComponent {
	...
	get href() {
		...
		try {
			...
			let message = `While generating link to route "${route}": ${e instanceof Error ? e.message : inspect(e)}`;
	...
	click(event) {
		...
		if (this.isLoading) {
			warn("This link is in an inactive loading state because at least one of its models currently has a null/undefined value, or the provided route name is invalid.", false, { id: "ember-glimmer.link-to.inactive-loading-state" });
			return;
		}
...
};
{
	...
	Object.defineProperty(prototype, "onUnsupportedArgument", {
		...
		value: function onUnsupportedArgument(name) {
			if (name === "href") assert(`Passing the \`@href\` argument to <LinkTo> is not supported.`);

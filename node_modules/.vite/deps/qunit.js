			...
			for (var x = 0; x < diffs.length; x++) {
				...
				switch (op) {
					...
					case DIFF_DELETE:
						...
						break;
					case DIFF_EQUAL: html[x] = "<span>" + escapeText(data) + "</span>";
				}
			}
			return html.join("");
		};
			...
			*/
			...
			QUnit.testDone(function(details) {
				...
				if (testPassed) addClass(assertList, "qunit-collapsed");
					...
					if (config.collapse) {
						if (!collapseNext) collapseNext = true;
			...
			window$1.addEventListener("unhandledrejection", function(event) {
				if (!QUnit.config.ignoreUnhandledRejections) QUnit.onUncaughtException(event.reason);
			});
		})();
	})();
}));

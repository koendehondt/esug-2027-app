...
import { D as isEmberArray, O as setEmberArray, T as tagFor, g as objectAt, i as descriptorForProperty, l as setClassicDecorator, o as isElementDescriptor, y as lookupDescriptor } from "./decorator-B5Uh5NFI-CxIWwiV3.js";
import { g as isTesting, l as info, y as assert } from "./debug-CzKtnQbf.js";
import { L as consumeTag, Y as track, k as UPDATE_TAG } from "./args-proxy-BNLuRFlO-EccNNvt4.js";
import { o as hasInternalComponentManager } from "./api-BawZUDYD-Cxxta-tL.js";
import { A as defineProperty, E as beginPropertyChanges, H as isProxy, I as PROXY_CONTENT, J as flushAsyncObservers, M as endPropertyChanges, O as computed, ct as getOwner, lt as isFactory, n as getProperties, q as addObserver, t as setProperties, x as set, y as inject$1, z as get } from "./set_properties-BghuuGJx-DFBAJlFx.js";
import { _ as Container, a as Observable, d as Mixin, g as intern, l as makeArray, m as guidFor, t as EmberObject, u as ActionHandler, y as makeDictionary } from "./object-xMsAYsCY.js";
import { c as once, d as schedule, i as _rsvpErrorQueue, p as getDispatchOverride, s as join, t as _backburner } from "./runloop-DUin4ckU.js";
import { t as Evented } from "./evented-D7wNd1QA.js";
import { a as replace, o as replaceInNativeArray } from "./array-Bh_kUjzy-VluBBc1S.js";
import { r as typeOf, t as compare } from "./compare-Co8dWDd_.js";
import { t as FrameworkObject } from "./-internals-BkCsZ6OB.js";
import { n as getEngineParent, r as setEngineParent, t as ENGINE_PARENT } from "./engine-parent-CUOAZ4io.js";
import { n as decorateMethodV2 } from "./runtime-CYyqkz5q-BOdRhmsS-CnoKbWmq.js";
//#region node_modules/ember-source/dist/dev/packages/shared-chunks/rsvp-CnCSY930.js
...
var RSVP$1 = /*#__PURE__*/ Object.freeze(/*#__PURE__*/ Object.defineProperty({
	__proto__: null,
	EventTarget,
	Promise: Promise$1,
	all,
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/-internals/runtime/lib/ext/rsvp.js
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/-internals/container/index.js
...
};
{
	...
	proto.normalizeInjectionsHash = function(hash) {
		let injections = [];
		for (let key in hash) if (Object.prototype.hasOwnProperty.call(hash, key)) {
			let value = hash[key];
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/enumerable/index.js
/**
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/enumerable/mutable.js
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/array/index.js
...
function uniqBy(array, keyOrFunc = identityFunction) {
	!isArray$2(array) && assert(`first argument passed to \`uniqBy\` should be array`, isArray$2(array));
	let ret = A();
...
function isArray$2(obj) {
	if (typeof obj === "object" && obj !== null) {
		...
		if (possibleProxyContent !== void 0) obj = possibleProxyContent;
	}
	if (!obj || obj.setInterval) return false;
	if (Array.isArray(obj) || EmberArray.detect(obj)) return true;
	let type = typeOf(obj);
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/controller/index.js
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/-internals/runtime/lib/mixins/container_proxy.js
/**
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/-internals/runtime/lib/mixins/registry_proxy.js
/**
@module ember
*/
/**
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/engine/instance.js
/**
@module @ember/engine
*/
/**
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/object/compat.js
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/route-recognizer/index.js
...
function getParam(params, key) {
	...
	if (!hasOwnProperty$1.call(params, key)) throw new Error("You must provide param `" + key + "` to `generate`.");
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/shared-chunks/unrecognized-url-error-B3wUTorp.js
...
var Transition = class Transition {
	...
	*/
	constructor(router, intent, state, error = void 0, previousTransition = void 0) {
		...
		this.sequence = -1;
		{
			let error = /* @__PURE__ */ new Error(`Transition creation stack`);
	...
	*/
	...
	rollback() {
		if (!this.isAborted) {
			...
			{
				let error = /* @__PURE__ */ new Error(`Transition aborted stack`);
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/routing/lib/generate_controller.js
/**
...
function generateController(owner, controllerName) {
	...
	if (get(instance, "namespace.LOG_ACTIVE_GENERATION")) info(`generated -> ${fullName}`, { fullName });
	return instance;
}
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/routing/lib/utils.js
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/routing/route.js
	...
	*/
	paramsFor(name) {
		...
		return Object.entries(queryParams).reduce((params, [key, value]) => {
			params[key] && assert(`The route '${this.routeName}' has both a dynamic segment and query param with name '${key}'. Please rename one to avoid collisions.`, !params[key]);
			params[key] = value;
			return params;
		}, params);
	}
	...
	*/
	...
	get _qp() {
		...
		if (controller) {
			...
			combinedQueryParameterConfiguration = mergeEachQueryParams(normalizeControllerQueryParams(get(controller, "queryParams") || []), queryParameterConfiguraton);
...
function buildRenderState(route) {
	...
	if (get(route._router, "namespace.LOG_VIEW_LOOKUPS") && !templateFactoryOrComponent) info(`Could not find "${name}" template. Nothing will be rendered`, { fullName: `template:${name}` });
	return render;
}
...
//#endregion
export { async as $, RouteRecognizer as A, isArray$2 as B, isTransitionAborted as C, prepareResult as D, merge as E, controller_exports as F, onerrorDefault as G, mutable_exports as H, A as I, RSVP as J, EventTarget as K, EmberArray as L, RegistryProxyMixin as M, ContainerProxyMixin as N, promiseLabel as O, Controller as P, asap as Q, MutableArray as R, isTransition as S, logAbort as T, Registry as U, MutableEnumerable as V, privatize as W, all as X, RSVP$1 as Y, allSettled as Z, extractQueryParams as _, hasDefaultSerialize as a, hash as at, isParam as b, getActiveTargetName as c, off as ct, generateControllerFactory as d, reject as dt, cast as et, PARAMS_SYMBOL as f, resolve$3 as ft, UnrecognizedURLError as g, Transition as h, getRenderState as i, filter as it, EngineInstance as j, throwIfAborted as k, resemblesURL as l, on as lt, STATE_SYMBOL as m, defaultSerialize as n, defer as nt, calculateCacheKey as o, hashSettled as ot, QUERY_PARAMS_SYMBOL as p, rethrow as pt, Promise$1 as q, getFullQueryParams as r, denodeify as rt, extractRouteArgs as s, map$1 as st, Route as t, configure as tt, shallowEqual as u, race as ut, forEach as v, log as w, isPromise as x, getChangelist as y, array_exports as z };

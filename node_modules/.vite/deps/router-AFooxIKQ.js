...
import { l as info, y as assert } from "./debug-CzKtnQbf.js";
import { O as computed, ct as getOwner$1, ut as setOwner, x as set, z as get } from "./set_properties-BghuuGJx-DFBAJlFx.js";
import { t as EmberObject } from "./object-xMsAYsCY.js";
import { c as once, f as scheduleOnce, l as run, o as cancel } from "./runloop-DUin4ckU.js";
import { A as RouteRecognizer, C as isTransitionAborted, D as prepareResult, E as merge, I as A, O as promiseLabel, S as isTransition, T as logAbort, W as privatize, _ as extractQueryParams, a as hasDefaultSerialize, b as isParam, c as getActiveTargetName, f as PARAMS_SYMBOL, g as UnrecognizedURLError, h as Transition, i as getRenderState, j as EngineInstance, k as throwIfAborted, l as resemblesURL, m as STATE_SYMBOL, n as defaultSerialize, o as calculateCacheKey, p as QUERY_PARAMS_SYMBOL, q as Promise$1, r as getFullQueryParams, s as extractRouteArgs, u as shallowEqual, v as forEach, w as log, x as isPromise, y as getChangelist } from "./route-Conu2YZZ.js";
import { t as Evented } from "./evented-D7wNd1QA.js";
import { r as typeOf } from "./compare-Co8dWDd_.js";
//#region node_modules/ember-source/dist/dev/packages/@ember/owner/index.js
var owner_exports = /* @__PURE__ */ __exportAll({
	getOwner: () => getOwner,
	setOwner: () => setOwner
});
/**
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/routing/lib/cache.js
/**
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/routing/lib/dsl.js
var uuid = 0;
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/routing/lib/router_state.js
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/router_js/index.js
...
//#endregion
//#region node_modules/ember-source/dist/dev/packages/@ember/routing/router.js
/**
...
function defaultDidTransition(infos) {
	...
	if (this.namespace.LOG_TRANSITIONS) console.log(`Transitioned into '${EmberRouter._routePath(infos)}'`);
}
function defaultWillTransition(oldInfos, newInfos) {
	if (this.namespace.LOG_TRANSITIONS) console.log(`Preparing to transition from '${EmberRouter._routePath(oldInfos)}' to '${EmberRouter._routePath(newInfos)}'`);
}
var freezeRouteInfo = (transition) => {
	if (transition.from !== null && !Object.isFrozen(transition.from)) Object.freeze(transition.from);
	if (transition.to !== null && !Object.isFrozen(transition.to)) Object.freeze(transition.to);
};
function K() {
	return this;
}
...
@public
*/
var EmberRouter = class EmberRouter extends EmberObject.extend(Evented) {
	/**
	...
	*/
	...
	_initRouterJs() {
		...
		class PrivateRouter extends Router {
			getRoute(name) {
				...
				if (!route) {
					...
					if (router.namespace.LOG_ACTIVE_GENERATION) info(`generated -> ${fullRouteName}`, { fullName: fullRouteName });
				}
		...
		if (this.namespace.LOG_TRANSITIONS_INTERNAL) routerMicrolib.log = console.log.bind(console);
	...
	*/
	...
	_setOutlets() {
		...
		if (!this._toplevelView) {
			...
			!(instance !== void 0) && assert("[BUG] unexpectedly missing `-application-instance:main`", instance !== void 0);
	...
	_queryParamsFor(routeInfos) {
		...
		for (let routeInfo of routeInfos) {
			...
			for (let qp of qpMeta.qps) {
				...
				if (qpOther && qpOther.controllerName !== qp.controllerName) assert(`You're not allowed to have more than one controller property map to the same query param key, but both \`${qpOther.scopedPropertyName}\` and \`${qp.scopedPropertyName}\` map to \`${urlKey}\`. You can fix this by mapping one of the controller properties to a different query param key via the \`as\` config option, e.g. \`${qpOther.prop}: { as: 'other-${qpOther.prop}' }\``, false);
	...
	_hydrateUnsuppliedQueryParams(state, queryParams, _fromRouterService) {
		...
		for (let routeInfo of routeInfos) {
			...
			for (let j = 0, qpLen = qpMeta.qps.length; j < qpLen; ++j) {
				...
				!function() {
					if (qp.urlKey === presentProp || qp.scopedPropertyName === presentProp) return true;
					if (_fromRouterService && presentProp !== false && qp.urlKey !== qp.prop) return false;
					return true;
...
function updatePaths(router) {
	...
	!info && assert("expected info", info);
...
//#endregion
export { owner_exports as i, BucketCache as n, getOwner as r, EmberRouter as t };

declare module 'ember-template-compiler/lib/public-api' {
    ...
    export { default as compileOptions, buildCompileOptions as _buildCompileOptions, transformsFor as _transformsFor, } from "ember-template-compiler/lib/system/compile-options";
    export { RESOLUTION_MODE_TRANSFORMS, STRICT_MODE_TRANSFORMS, } from "@ember/template-compiler/-internal-primitives";

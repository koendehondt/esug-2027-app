declare module '@glimmer/compiler/lib/passes/1-normalization/visitors/statements' {
    ...
    import { OptionalList } from "@glimmer/compiler/lib/shared/list";
    ...
    export const VISIT_STMTS: NormalizationStatements;
    export {};
}
declare module '@ember/routing/lib/controller_for' {
    ...
    */
    /**
      ...
      @private
    */
    export default function controllerFor(container: Container, controllerName: string, lookupOptions: RegisterOptions): InternalFactory<object, FactoryClass> | object | undefined;
}
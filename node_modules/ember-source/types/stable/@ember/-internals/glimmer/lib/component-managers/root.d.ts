declare module '@ember/-internals/glimmer/lib/component-managers/root' {
    import type { ComponentDefinition, Environment, Owner, VMArguments } from "@glimmer/interfaces";
    ...
    class RootComponentManager extends CurlyComponentManager {
        ...
        create(_owner: Owner, _state: unknown, _args: Nullable<VMArguments>, { isInteractive }: Environment, dynamicScope: DynamicScope): ComponentStateBucket;
    }

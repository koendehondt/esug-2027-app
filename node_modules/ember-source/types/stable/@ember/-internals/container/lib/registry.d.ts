declare module '@ember/-internals/container/lib/registry' {
    import type { Factory, FactoryClass, FullName, InternalFactory, KnownForTypeResult, RegisterOptions, Resolver } from "@ember/-internals/owner";
    ...
    export interface ResolverClass extends Factory<Resolver>, Partial<{

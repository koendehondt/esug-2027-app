declare module '@ember/-internals/utils' {
    ...
    export { checkHasSuper, ROOT, wrap, observerListenerMetaFor, setObservers, setListeners, } from "@ember/-internals/utils/lib/super";
    ...
    export { setupMandatorySetter, teardownMandatorySetter, setWithMandatorySetter, } from "@ember/-internals/utils/lib/mandatory-setter";
}